                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-bot">
                            ...
                            <div class="form-button fl fl-ai-c">
                                ...
                                <?php endif ?>
                                <button id="<?= $this->sendButtonId ?>" type="submit" class="btn btn-black">
                                    <?= $this->sendButtonText ?>
                                </button>

                                <div class="terms_of_use">
                                    * Оставляя заявку Вы соглашаетесь с 
                                    <a target="_blank" href="/politika-konfidencialnosti">Политикой в отношении обработки персональных данных</a>
                                </div>
                            </div>
                        </div>
