...
<div class="content-site">
    ...
    <div class='row'>
        <div class="col-sm-6 col-sm-offset-3 generate">
        ...
        <!-- <div class="form-group" style="padding: 5px 0 0 15px;">
            <?php $this->widget(
                'bootstrap.widgets.TbButton',
                [
                    'label' => Yii::t('UserModule.user', 'Generate password'),
    ...
    <?php if ($module->showCaptcha && CCaptcha::checkRequirements()): { ?>
        <div class="row">
            ...
            <div class="col-sm-6 col-sm-offset-3 col-xs-4">
                <?php $this->widget(
                    'CCaptcha',
                    [
        ...
        <div class="col-sm-6 col-sm-offset-3 col-xs-12">
            <?php $this->widget(
                ...
                [
                    ...
                    'htmlOptions' => ['class' => 'btn btn-brown']
                ]
            ); ?>
        </div>
    </div>
