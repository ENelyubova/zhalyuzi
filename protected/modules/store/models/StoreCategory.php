...
class StoreCategory extends \yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['meta_canonical', 'url'],
            ['data, in_view_materials, name_material, in_view_complect', 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'in_view_materials' => "Вывод категории в материалах(если они есть у категории)",
            'name_material' => "Название категории в листинге материалов",
            'in_view_complect' => "Вывод категории в комплектующих(если они есть у категории)",
        ];
    }
    ...
    public function getMaterialUrl()
    {
        ...
        return Yii::app()->createUrl('store/material/view', ['slug' => $slug]);
    }
