...
class FileUploadBehavior extends CActiveRecordBehavior
{
    ...
    public function getFileNewUrl($attribute = null)
    {
        $path = $this->getUploadPath();

        $attribute = $attribute ?: $this->attributeName;
        return $this->uploadManager->getFileUrl($this->getOwner()->{$attribute}, $path);
    }

    /**
     * @return mixed
     */
    public function getFileNewPath($attribute = null, $path = null)
    {
        $path = $path ?: $this->getUploadPath();
